...
# by deafult setting of compilation, java only includes your codes without dependencies
# Maven has a plugin to allow to package all codes and dependencies into one jar, which is called "fat jar"
