...
public class ConsumerDemoWithAssignSeek {
    public static void main(String[] args) {
        new ConsumerDemoWithAssignSeek().run();
    ...
    public void run(){
        ...
        Runnable myConsumerRunnable = new ConsumerRunnable(topic, partition, offsetToReadFrom, bootstrapServers, offsetReset, latch);
    ...
    public class ConsumerRunnable implements Runnable {
        ...
        private Logger logger = LoggerFactory.getLogger(ConsumerDemoWithAssignSeek.class.getName());
        public ConsumerRunnable(String topic, int partition, long offsetToReadFrom, String bootstrapServers, String offsetReset, CountDownLatch latch){
            this.latch = latch;
